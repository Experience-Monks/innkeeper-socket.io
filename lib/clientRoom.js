...
p.emit = function() {
  ...
  this.ioClient.emit.apply( this.ioClient, arguments );
 ...
 *  Set room to public
 * 
 * @return {Promise} A promise will be returned which will resolve once the room is made public
 */
p.setPublic = function() {
  ...
  return new promise( function( ok, err ) {
    ...
    ioClient.emit( events.ROOM_PUBLIC, {
 ...
 *  Set room to private
 * 
 * @return {Promise} A promise will be returned which will resolve once the room is made private
 */
p.setPrivate = function() {
  ...
  return new promise( function( ok, err ) {
    ...
    ioClient.emit( events.ROOM_PRIVATE, {
